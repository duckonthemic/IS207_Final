            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center">
                    ...
                    <div class="flex items-center text-blue-600">
                        <div class="h-10 w-10 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold shadow-lg shadow-blue-500/30">2</div>
            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="{{ route('checkout.shipping') }}" class="text-blue-600 text-sm font-medium hover:text-blue-700 hover:underline transition-colors">Thay đổi</a>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    ...
                    <form method="POST" action="{{ route('checkout.store-payment') }}" id="payment-form">
                        ...
                        <div class="space-y-4">
                            ...
                            <label class="block cursor-pointer group relative">
                                ...
                                <div class="border-2 border-gray-100 rounded-xl p-6 transition-all peer-checked:border-blue-500 peer-checked:bg-blue-50/50 hover:border-blue-200">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500 mt-1">Chuyển khoản qua ngân hàng (Internet Banking/QR Code)</p>
                                            </div>
                                        </div>
                                        <div class="w-6 h-6 rounded-full border-2 border-gray-300 peer-checked:border-blue-600 peer-checked:bg-blue-600 flex items-center justify-center transition-colors">
                                            <div class="w-2.5 h-2.5 bg-white rounded-full opacity-0 peer-checked:opacity-100 transition-opacity"></div>
                                    ...
                                    <div class="hidden peer-checked:block bg-white rounded-xl p-6 mt-4 border border-gray-200 shadow-sm">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
                                                <div class="flex items-center justify-between mb-3">
                                                    ...
                                                    <button type="button" onclick="copyToClipboard('19037859362018', this)" class="text-xs px-2.5 py-1.5 bg-white border border-gray-200 rounded-md text-gray-600 hover:text-blue-600 hover:border-blue-600 transition-all font-medium shadow-sm">
                                                        Sao chép
                                                    </button>
                                                </div>
                                                <p class="text-sm text-gray-500 mb-1">Số tài khoản</p>
                                                <p class="text-lg font-mono font-bold text-gray-900 mb-2">19037859362018</p>
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
                                                <div class="flex items-center justify-between mb-3">
                                                    ...
                                                    <button type="button" onclick="copyToClipboard('123456789', this)" class="text-xs px-2.5 py-1.5 bg-white border border-gray-200 rounded-md text-gray-600 hover:text-blue-600 hover:border-blue-600 transition-all font-medium shadow-sm">
                                                        Sao chép
                                                    </button>
                                                </div>
                                                <p class="text-sm text-gray-500 mb-1">Số tài khoản</p>
                                        ...
                                        <div class="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-100 flex items-start gap-3">
                                            ...
                                            <p class="text-sm text-yellow-800">
                                                Vui lòng ghi rõ nội dung chuyển khoản: <span class="font-bold">Họ tên + Số điện thoại</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-100">
                            <a href="{{ route('checkout.shipping') }}" class="px-6 py-3.5 border-2 border-gray-200 text-gray-700 rounded-xl hover:border-gray-900 hover:text-gray-900 transition-all font-bold text-center">
                                ← Quay lại
                            </a>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                    ...
                    <div class="border-t border-gray-100 pt-4 mt-4">
                        <div class="flex justify-between items-end">
                            ...
                            <span class="text-2xl font-bold text-blue-600">{{ number_format($cart->getTotal() + 30000, 0, ',', '.') }}₫</span>
                        </div>
