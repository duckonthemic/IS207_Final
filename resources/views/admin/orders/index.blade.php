        ...
        <form action="{{ route('admin.orders.index') }}" method="GET" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="SEARCH ORDER CODE..." class="w-full bg-cyber-gray border border-cyber-border text-cyber-white placeholder-cyber-text-muted rounded-none px-4 py-2 focus:border-cyber-white focus:outline-none transition font-mono text-sm">
                </div>

                <!-- Order Status Filter -->
                <div>
                    <label class="block text-cyber-text-muted text-xs font-bold uppercase tracking-wider mb-2">Order Status</label>
                ...
                <div>
                    <label class="block text-cyber-text-muted text-xs font-bold uppercase tracking-wider mb-2">Payment Status</label>
                    <select name="payment_status" class="w-full bg-cyber-gray border border-cyber-border text-cyber-white rounded-none px-4 py-2 focus:border-cyber-white focus:outline-none transition font-mono text-sm uppercase">
            ...
            <div class="flex gap-2 pt-2">
                ...
                <a href="{{ route('admin.orders.index') }}" class="px-6 py-2 bg-transparent border border-cyber-white text-cyber-white rounded-none hover:bg-cyber-white hover:text-cyber-black transition font-bold uppercase tracking-wider text-sm">
                    Clear
                </a>
            </div>
        </form>
                ...
                <tbody class="divide-y divide-cyber-border">
                    ...
                    <tr class="hover:bg-cyber-gray transition group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <span class="text-cyber-white font-mono font-bold">{{ number_format($order->total_amount, 0, ',', '.') }}₫</span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            ...
                            @endphp
                            <span class="inline-block px-2 py-1 border {{ $paymentColor }} text-xs font-bold uppercase tracking-wider">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @endphp
                            <span class="inline-block px-2 py-1 border {{ $statusColor }} text-xs font-bold uppercase tracking-wider">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('admin.orders.show', $order) }}" class="inline-flex items-center px-3 py-1 border border-cyber-white text-cyber-white hover:bg-cyber-white hover:text-cyber-black transition text-xs font-bold uppercase tracking-wider">
