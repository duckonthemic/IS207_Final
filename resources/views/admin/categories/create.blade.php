...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-black text-cyber-white uppercase tracking-tighter">Create Category</h1>
            <p class="text-cyber-text-muted font-mono text-sm mt-1">// NEW_CATEGORY_ENTRY</p>
        </div>
